...
from AWD_model import AWAClassifier
import random
...
def main(args):
    ...
    classifier = AWAClassifier(label_list=label_list, device=device, cache_dir=args.cache, gamma=args.gamma, adv_rd=args.adv_iter)
