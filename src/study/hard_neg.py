...
def main(args):
    ...
    classifier = AWAClassifier(label_list=label_list, device=device, cache_dir=args.cache, reg=args.reg_l, adv_rd=args.adv_iter, fix_adv=True)
